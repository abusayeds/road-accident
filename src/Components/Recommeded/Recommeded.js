    ...
    return (
        <main> 
            ...
            <section className='flex  mt-1 p-2  '>
                <div className='w-3/6'>
                    <Link to= '/bd'><img className=' zoom rounded' src="https://image.slidesharecdn.com/presentation1-190322171937/75/road-accident-in-bangladesh-1-2048.jpg?cb=1668305366" alt=""  /></Link>
                </div>
            ...
            <section className='flex   p-2 '>
                <div className='w-3/6'>
                <Link to= '/pk'><img className=' zoom rounded' src="https://i.tribune.com.pk/media/images/kallarkaharaccident41687009981-1/kallarkaharaccident41687009981-1.jpg" alt=""  /></Link> 
                </div>
                <div className=' md:mt-4 ml-3 text-start '>
            ...
            <section className='flex   p-2 '>
                <div className='w-3/6'>
                <Link to= '/id'> <img className=' zoom rounded' src="https://i.ytimg.com/vi/DksPfrGqw4c/hqdefault.jpg" alt=""  /></Link>
                </div>
                <div className=' md:mt-4 ml-3 text-start '>
            ...
            <section className='flex  mt-1 p-2 '>
                <div className='w-3/6'>
                <Link to= '/np'> <img className=' zoom rounded' src="https://omgnepal.com/wp-content/uploads/2017/11/y.jpg" alt=""  /></Link> 
                </div>
                <div className=' md:mt-4 ml-3 text-start '>
            ...
            <section className='flex   p-2 '>
                <div className='w-3/6'>
                <Link to= '/md'> <img className=' zoom rounded' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvEYDHirSWSqfeoiD6od-oAzQzV1Dx6GS91A" alt="" /></Link>
                </div>
                <div className=' md:mt-4 ml-3 text-start '>
            ...
            <section className='flex   p-2 '>
                <div className='w-3/6'>
                <Link to= '/cd'>  <img className=' zoom rounded' src="https://ukranews.com/upload/media/2021/04/23/6082a2a91d6e3-Trafik._Dorozhnoe_dvizhenie_v_Kitae.jpg" alt="" /></Link>
                </div>
                <div className=' md:mt-4 ml-3 text-start '>
